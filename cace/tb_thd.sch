...
.include \{DUT_path\}
"}
C {devices/code_shown.sym} 90 -1010 0 0 {name=CONTROL only_toplevel=false value="
.four 1kHz v(a) v(out)
.control
tran 10u 20m
fourier 1k v(out) v(a)
let idx = 2
...
set wr_singlescale
wrdata \{simpath\}/\{filename\}_\{N\}.data thd
plot out
quit
.endc
"}
...
.ends
"}
C {devices/vsource.sym} 180 -510 0 0 {name=Va value="sin(0.707 0.707 1k)"}
...
C {devices/isource.sym} 270 -620 0 0 {name=I0 value=\{iw\}}
